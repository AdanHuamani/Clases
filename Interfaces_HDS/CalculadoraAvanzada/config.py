...
# Coonstantes para el tema claro
...
#Funcion que nos permite centra nuestra pantalla.
def centrar_ventana(ventana,ancho_ventana,largo_ventana):
    ...
    return ventana.geometry(f"{ancho_ventana}x{largo_ventana}+{x}+{y}") #geometry ("300x400")